...
Return only the JSON array.`;
  ...
  return (
    <div className="flex-1 w-full max-w-5xl mx-auto flex flex-col items-center justify-center py-10 px-4 min-h-[60dvh]">
      <style>{`
        @keyframes shake {
      ...
      {error && (
        <div className="fixed top-24 left-1/2 -translate-x-1/2 z-[100] bg-red-500 text-white px-6 py-3 rounded-2xl font-bold shadow-2xl flex items-center gap-3 animate-in slide-in-from-top-4">
          ...
          <div className="text-xs break-all max-w-md">{error}</div>
